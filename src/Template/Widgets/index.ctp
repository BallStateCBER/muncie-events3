...
<p>
    Click on
    <?php echo $this->Html->link('Event Feed Widget', [
        'action' => 'customize',
        'feed'
    ]); ?>
    or
    <?php echo $this->Html->link('Monthly Calendar Widget', [
        'action' => 'customize',
        'month'
    ]); ?>
...
<div id="widgets_overview row">
    <div class="col-xs-12 col-lg-4 float-left">
        ...
        <iframe class="widgets" src="<?php echo Router::url(['action' => 'feed'], true); ?>"></iframe>
    </div>
    <div class="col-xs-12 col-lg-8 float-right">
        ...
        <iframe class="widgets" src="<?php echo Router::url(['action' => 'month'], true); ?>"></iframe>
    </div>
</div>
